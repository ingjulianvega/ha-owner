...
public class ErrorCodeMessages {
    ...
    public static final String OWNER_NOT_FOUND_API_CODE = "401";
    public static final String OWNER_NOT_FOUND_ERROR = "OWNER_NOT_FOUND";
    public static final String OWNER_NOT_FOUND_MESSAGE = "No se encontró el responsable";
    public static final String OWNER_NOT_FOUND_SOLUTION = "Verifique los datos";
