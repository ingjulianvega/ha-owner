...
import ingjulianvega.ximic.haowner.configuration.OwnerParameters;
...
public class MvcExceptionHandler extends ResponseEntityExceptionHandler {
    ...
    public MvcExceptionHandler(OwnerParameters ownerParameters) {
        this.ownerParameters = ownerParameters;
    }
    ...
    public ResponseEntity<ApiError> validationErrorHandler(OwnerException ame) {
        ApiError apiError = ApiError
                .builder()
                .timestamp(LocalDateTime.now())
                .api(ownerParameters.getApi())
